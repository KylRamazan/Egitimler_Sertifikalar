...
<body>
    <div class="sidenav">
		...
		<div class="col-4 side_top_left">
			<img src="web/images/technical.png" alt="news image" class="img-fluid navimg">
		</div>
        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
					...
					<p class="banp mx-auto mt-3">24 farklı kategoride yüzlerce ürünle sizlerin hizmetinizdeyiz.</p>
    ...
    <div class="wthree_pvtits-services align-w3" id="services">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                ...
                <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik sorun oluştuğu zaman 2 yıl süre ile herhangi bir ücret ödemeden tamir ve onarım işlemleri yapılmaktadır.</p>
                <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" style="background-color:lightpink" href="WebForm1.aspx" role="button">Arızalı Ürün Takibi</a>
            </div>
...
<!-- contact -->
	 <section class="wedo" id="contact">
		   ...
		   <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da aldığınız herhangi bir ürüne dair soru ve sorunlarınızda aşağıdaki panelden bize mesaj atarak ulaşabilirsiniz.Mailinize en kısa sürede dönüş yapılacaktır.</p>
		   <div class="contact_grid_right mt-5 mx-auto text-center">
			...
			<div class="follow">
				<ul class="social_section_1info">
					...
					<li><a href="https://www.dribbble.com"><span class="fa fa-dribbble"></span></a></li>
					
					<li><a href="https://www.vimeo.com"><span class="fa fa-vimeo"></span></a></li>
					<li><a href="https://www.linkedin.com"><span class="fa fa-linkedin"></span></a></li>
				</ul>
			</div>
				<p>© 2020 Teknik Servis ve Ürün Takibi | Tüm Hakları Saklıdır.
