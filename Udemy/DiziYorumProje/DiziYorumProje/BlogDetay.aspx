		  ...
		  <div class="col-md-8 single-main">				 
			 <div class="single-grid">
				 ...
				 <ItemTemplate>
					<ul class="comment-list">
		  		 		<li><img src="web/images/avatar.png" class="img-responsive" alt="">
		  		 			<div class="desc">
		  		 				<p style="font-weight:bolder"><%# Eval("KISIAD") %> :</p> <p><%# Eval("YORUMICERIK") %></p>
		  		 			</div>
			  ...
			  <div class="content-form">
					...
					<form runat="server">
                        <asp:TextBox ID="TxtKullaniciAdi" runat="server" placeholder="Kullanıcı Adı" required=""></asp:TextBox>
						<asp:TextBox ID="TxtMail" runat="server" placeholder="Email" required=""></asp:TextBox>
						<asp:TextBox ID="TxtMesaj" runat="server" placeholder="Mesajınız..." TextMode="MultiLine" required=""></asp:TextBox>
